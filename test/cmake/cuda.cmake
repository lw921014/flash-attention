if(WITH_NV_JETSON)
  ...
  set(aiak_inference_known_gpu_archs "53 62 72")
  set(aiak_inference_known_gpu_archs10 "53 62 72")
elseif(NEW_RELEASE_CUBIN)
  message("Using New Release Strategy - Cubin Packge")
  add_definitions(-DNEW_RELEASE_CUBIN)
  set(aiak_inference_known_gpu_archs "35 37 50 52 60 61 70 75 80 86")
  set(aiak_inference_known_gpu_archs10 "50 60 70 75")
  set(aiak_inference_known_gpu_archs11 "60 70 75 80")
elseif(NEW_RELEASE_JIT)
  message("Using New Release Strategy - JIT Packge")
  add_definitions(-DNEW_RELEASE_JIT)
  set(aiak_inference_known_gpu_archs "35 37 50 52 60 61 70 75 80 86")
  set(aiak_inference_known_gpu_archs10 "35 50 60 70 75")
  set(aiak_inference_known_gpu_archs11 "35 50 60 70 75 80")
else()
  set(aiak_inference_known_gpu_archs "35 50 52 60 61 70 75 80")
  set(aiak_inference_known_gpu_archs10 "35 50 52 60 61 70 75")
  set(aiak_inference_known_gpu_archs11 "52 60 61 70 75 80")
endif()
...
function(detect_installed_gpus out_variable)
  ...
  if(NOT CUDA_gpu_detect_output)
    ...
    set(${out_variable} ${aiak_inference_known_gpu_archs} PARENT_SCOPE)
  else()
...
function(select_nvcc_arch_flags out_variable)
  ...
  if(${CUDA_ARCH_NAME} STREQUAL "Manual")
    set(CUDA_ARCH_BIN ${aiak_inference_known_gpu_archs} CACHE STRING "Specify 'real' GPU architectures to build binaries for, BIN(PTX) format is supported")
  ...
  elseif(${CUDA_ARCH_NAME} STREQUAL "All")
    set(cuda_arch_bin ${aiak_inference_known_gpu_archs})
...
if (${CMAKE_CUDA_COMPILER_VERSION} LESS 11.0) # CUDA 10.x
  set(aiak_inference_known_gpu_archs ${aiak_inference_known_gpu_archs10})
  set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} -D_MWAITXINTRIN_H_INCLUDED")
  set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} -D__STRICT_ANSI__")
  set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} -Wno-deprecated-gpu-targets")
elseif (${CMAKE_CUDA_COMPILER_VERSION} LESS 11.2) # CUDA 11.0/11.1
  set(aiak_inference_known_gpu_archs ${aiak_inference_known_gpu_archs11})
  set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} -D_MWAITXINTRIN_H_INCLUDED")
  set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} -D__STRICT_ANSI__")
  set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} -Wno-deprecated-gpu-targets")
elseif (${CMAKE_CUDA_COMPILER_VERSION} LESS 12.0) # CUDA 11.2+
  set(aiak_inference_known_gpu_archs "${aiak_inference_known_gpu_archs11} 86")
  set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} -D_MWAITXINTRIN_H_INCLUDED")
  set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} -D__STRICT_ANSI__")
  set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} -Wno-deprecated-gpu-targets")
endif()
...
# (Note) in order to use fast math instruction, need to add flag use_fast_math, 
# see https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html#intrinsic-functions 
set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} --expt-extended-lambda -Xcompiler -fPIC -use_fast_math")
